...
import P5 from '../../public/assets/img/products/5.png'
import P6 from '../../public/assets/img/products/6.png'
...
const ProductsSection = () => {
  ...
  <div className="container-fluid  products-heading " data-aos="fade-up">  
    <div className="row">     
      <div className="col-lg-8">
        <h2 className="font2 fs50 color1 fw300 lh64">products</h2>
      </div>
  ...
  <div className="container-fluid padr0" data-aos="fade-up"> 
    <div className="row gy-6 g-0 ">
      <div className="col-lg-4 mt-5  ">
        <div className="box" data-aos="fade-up" data-aos-delay={100}>             
          ...
          <div className="productinfo">
            ...
            <p className="font2 fs16 color1 fw300 lh24">A meeting management tool to do meetings more efficiently – invite participants from within the office or outside, share agendas, keep track of the history, assign tasks and also keep track of your to-dos. Be it one-off meetings, recursive or board meetings, this tool has them.
            </p>
          </div>
      ...
      <div className="col-lg-4  mt-5 ">
        <div className="box" data-aos="fade-up" data-aos-delay={100}>
        <Image alt="img"  src={P5} className="img-fluid"  />
          <div className="productinfo">
            <h3 className="font2 fs22 color1 fw300 lh36">eRecruitment</h3>
            <p className="font2 fs16 color1 fw300 lh24">Bring automation in the whole recruiting process with this simple system. eRecruitment allows management to ensure efficiency in the job recruitment process and employee placement.</p>
          </div>
          <div className=" text-lg-start arrowset">
            <span className="btn-read-more d-inline-flex align-items-center justify-content-center align-self-center">
              <i className="bi"> <Image alt="img"  className="arrow-2" src={A4} /> </i>
      ...
      <div className="col-lg-4  mt-5 ">
        <div className="box" data-aos="fade-up" data-aos-delay={200}>
        <Image alt="img"  src={P6} className="img-fluid"  />
          <div className="productinfo">
            <h3 className="font2 fs22 color1 fw300 lh36">iAudit</h3>
            <p className="font2 fs16 color1 fw300 lh24">Make auditing faster and simpler with more insight and less paperwork with this all-in-one audit management system.</p>
          </div>
          <div className=" text-lg-start arrowset">
            <span className="btn-read-more d-inline-flex align-items-center justify-content-center align-self-center">
              <i className="bi">  <Image alt="img"  className="arrow-2" src={A4} /> </i>
